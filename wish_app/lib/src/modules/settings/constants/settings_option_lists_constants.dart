...
List<LanguageItem> languageDropdownList = [
  LanguageItem(
    value: 0,
    // title: "System",
    title: "settings_language_item_system",
    locale: Get.deviceLocale ?? translations_constants.localeEnUS,
  ),
  LanguageItem(
    value: 1,
    // title: "English",
    title: "settings_language_item_english",
    locale: translations_constants.localeEnUS,
  ),
  LanguageItem(
    value: 2,
    // title: "Russian",
    title: "settings_language_item_russian",
...
List<ThemeItem> themeDropdownList = [
  ThemeItem(
    ...
    // title: "System",
    title: "settings_theme_item_system",
  ...
  ThemeItem(
    ...
    // title: "Light",
    title: "settings_theme_item_light",
  ...
  ThemeItem(
    ...
    mode: ThemeMode.dark,
    // title: "Dark",
    title: "settings_theme_item_dark",
